...
def sol():
    return f"\n--------------------------------------SOLUTION------------------------------------------- \n Since we don't know the exact number of {item} in the {container}. Let us represent the number of {item} as variable '{variable}'".format(item=item, container=container, variable=variable)
